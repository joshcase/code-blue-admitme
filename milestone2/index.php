		...
		<div class="input-section">
			...
			<div class="input-group">
				...
				<div class="observation">
					<span>Heart rate</span><input type="number">
				</div>
				<div class="observation">
					<span>Blood pressure</span><input type="text">
				</div>
				<div class="observation">
					<span>Respiratory rate</span><input type="number">
				</div>
				<div class="observation">
					<span>Temperature</span><input type="number" step="0.1">
				</div>
				<div class="observation">
					<span>Oxygen saturation</span><input type="number">
				</div>
			</div>
